...
function SideBar() {
  return (
    <>
      <aside
        id="default-sidebar"
        className="fixed left-0 top-0 z-40 mt-16 h-screen w-64 min-w-[200px] -translate-x-full transition-transform sm:translate-x-0"
        aria-label="Sidebar"
      >
        <div className="h-full overflow-y-auto bg-gray-50 px-3 py-4 dark:bg-gray-800">
          <ul className="space-y-2 font-medium">
            ...
            <li>
              <a
                href="/adminPanel?section=adduser"
                className="group flex items-center rounded-lg p-2 text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
              >
                <svg
                ...
                <span className="ms-3 flex-1 whitespace-nowrap">Add User</span>
